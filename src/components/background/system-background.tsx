export function SystemBackground() {
  return (
    ...
    >
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,rgba(28,62,78,0.22),transparent_50%)]" />
      ...
      <div className="absolute inset-0 bg-[linear-gradient(to_bottom,transparent,rgba(5,7,11,0.4))]" />
    </div>
  );
}
